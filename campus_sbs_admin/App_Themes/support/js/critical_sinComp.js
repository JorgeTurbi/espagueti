! function(exports, global) {
    function domTransplant() {
        $("[data-transplant-id][data-transplant]").each(function() {
            elementID = $(this).attr("data-transplant-id"), elementObject = $(this), windowWidth > mdBreak && (elementDestination = $("[data-transplant-id=" + elementID + "][data-transplant-lg]")), mdBreak >= windowWidth && (elementDestination = $("[data-transplant-id=" + elementID + "][data-transplant-md]")), smBreak >= windowWidth && (elementDestination = $("[data-transplant-id=" + elementID + "][data-transplant-sm]")), xsBreak >= windowWidth && (elementDestination = $("[data-transplant-id=" + elementID + "][data-transplant-xs]")), elementObject.appendTo(elementDestination)
        })
    }
    ...
    function insertBG() {
        $("[data-background]").each(function() {
            backgroundBox = $(this).attr(is_retina_device() === !0 ? "data-background-2x" : "data-background"), $(this).css("background-image", "url(" + backgroundBox + ")")
        })
    }

    function initHelpers() {
        domTransplant(), sameHeight(), makeSquare(), autoHeight(), insertBG()
    }

    function placeVideo() {
        windowWidth = $(window).width(), windowHeight = $(window).height(), $("#video-home").css("width", windowWidth), $("#video-home").css("height", windowHeight)
    }
    global["true"] = exports, ! function(a, b) {
        ...
        ScrollSpy.VERSION = "3.3.1", ScrollSpy.DEFAULTS = {
            offset: 10
    ...
    }(jQuery), windowWidth = $(window).width(), $(window).resize(function() {
        windowWidth = $(window).width()
    }), xsBreak = 767, smBreak = 991, mdBreak = 1199, $(function() {
        $(window).load(function() {
            $("#grid .bg").height($("body").height())
        }), $(window).load(function() {
            0 !== $('[data-spy="affix"]').length && $('[data-spy="affix"]').each(function() {
                affixHolderHeight = $(this).outerHeight(), affixID = $(this).attr("id"), $(this).wrap('<div id="' + affixID + '-holder" class="affix-holder"></div>'), $(this).parent().height(affixHolderHeight), affixHolderOffset = $(this).offset().top - affixHolderHeight, $(this).attr("data-offset-top", affixHolderOffset)
            })
            ...
            "true" == $(this).attr("data-controls") && ($(this).after('<button class="more" title="Aumentar">+</button>'), $(this).before('<button class="less" title="Reducir">-</button>'))
        }), $("[data-animation-out]").length > 0 && ($("body").addClass("page-transitions"), $("[data-animation-in]").each(function() {
            animationIn = $(this).attr("data-animation-in"), $(this).addClass("animated " + animationIn)
        }), $("body.page-transitions a").on("click", function(e) {
            href = $(this).attr("href"), $("[data-animation-out]").each(function() {
                animationOut = $(this).attr("data-animation-out"), $(this).addClass("animated " + animationOut)
            }), $("[data-animation-out]").one("webkitAnimationEnd oanimationend msAnimationEnd animationend", function() {
                history.pushState({}, null, href), $("body").load(href)
            }), e.preventDefault()
        })), initHelpers(), $(window).on("resize", function() {
            initHelpers()
        })
    }), $(function() {
        placeVideo(), $("#search-header + .input-group-addon").mouseenter(function() {
            ...
            $(".contact-options").find(".info-hidden").hide(), $(this).next().fadeIn(300)
        }), $(".js-close-parent").click(function() {
            $(this).parent().fadeOut(500)
        }), $(".js-open-next").click(function() {
            $(this).next().toggleClass("hide"), $(this).parent().toggleClass("opened")
        });
        var numTabs = $(".nav-tabs.auto-size li").length,
            sizeTab = 100 / numTabs;
        $(".nav-tabs li").css("width", sizeTab + "%"), $(window).on("resize", function() {
            placeVideo()
        })
    }), $(function() {
