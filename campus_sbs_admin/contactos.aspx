<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contactos.aspx.cs" Inherits="campus_sbs_admin.contactos" %>
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    <div class="col-sm-12">
                        <fieldset>
                            <legend id="txt_contactos" class="text-color-primary" runat="server"></legend>
                        </fieldset>
                    </div>
                    <div id="table_listado_contactos" class="col-sm-12" runat="server"></div>

                    <!-- Hidden y botones ocultos -->
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <asp:HiddenField ID="hidIdContacto" runat="server" />
                        <asp:ImageButton ID="btnBorrarContacto" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" OnClick="btnBorrarContacto_Click" class="hidden" />
                    </form>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">    
        ...
        function eliminarContacto(id) {
            var hidId = document.getElementById('<%=hidIdContacto.ClientID %>');
            hidId.value = id;

            var boton = document.getElementById('<%=btnBorrarContacto.ClientID %>');
            boton.click();
        }
    </script>
</body>
