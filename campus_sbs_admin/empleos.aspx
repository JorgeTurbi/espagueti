<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="empleos.aspx.cs" Inherits="campus_sbs_admin.empleos" %>
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    <div class="col-sm-12">
                        <fieldset>
                            <legend id="txt_empleos" class="text-color-primary" runat="server"></legend>
                        </fieldset>
                    </div>
                    <div id="table_listado_empleos" class="col-sm-12" runat="server"></div>

                    <!-- Hidden y botones ocultos -->
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <asp:HiddenField ID="hidIdEmpleo" runat="server" />
                        <asp:ImageButton ID="btnBorrarEmpleo" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" OnClick="btnBorrarEmpleo_Click" CssClass="hidden" />
                    </form>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">    
        ...
        function eliminarEmpleo(id) {
            var hidId = document.getElementById('<%=hidIdEmpleo.ClientID %>');
            hidId.value = id;

            var boton = document.getElementById('<%=btnBorrarEmpleo.ClientID %>');
            boton.click();
        }
    </script>
</body>
