<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lista-banners.aspx.cs" Inherits="campus_sbs_admin.lista_banners" %>
...
<head runat="server">
    <title>SBS | Lista de banners</title>
    ...
    <!-- CSS 
     ...
     <style type="text/css">
         ...
         .badge:hover, .badge:active, .badge:focus {color: #223266; text-decoration: none; background-color: transparent;}
         .tooltip{border: 0 none}
         .tooltip.top {background-color:transparent; padding:0; margin-top: -7px;}
         .tooltip.top .tooltip-arrow{border-width:5px 5px 0;border-top-color:#000}
         .tooltip.top-left .tooltip-arrow{border-width:5px 5px 0;border-top-color:#000}
         .tooltip.top-right .tooltip-arrow{border-width:5px 5px 0;border-top-color:#000}
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    <div class="col-sm-12">
                        <fieldset>
                            <legend id="txt_banners" class="text-color-primary" runat="server"></legend>
                        </fieldset>
                    </div>
                    <div id="table_listado_banners" class="col-sm-12" runat="server"></div>

                    <!-- Hidden y botones ocultos -->
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <asp:HiddenField ID="hidIdBanner" runat="server" />
                        <asp:ImageButton ID="btnBorrarBanner" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" CssClass="hidden" OnClick="btnBorrarBanner_Click" />
                    </form>
