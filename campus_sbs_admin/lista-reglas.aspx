<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lista-reglas.aspx.cs" Inherits="campus_sbs_admin.lista_reglas" %>
...
<head runat="server">
    <title>SBS | Lista reglas automatización</title>
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    <div class="col-sm-12">
                        <fieldset>
                            <legend id="txt_reglas" class="text-color-primary" runat="server"></legend>
                        </fieldset>
                    </div>
                    <div id="table_listado_reglas" class="col-sm-12" runat="server"></div>

                    <!-- Hidden y botones ocultos -->
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <asp:HiddenField ID="hidIdRegla" runat="server" />
                        <asp:ImageButton ID="btnActivarRegla" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" CssClass="hidden" OnClick="btnActivarRegla_Click" />
                        <asp:ImageButton ID="btnBorrarRegla" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" CssClass="hidden" OnClick="btnBorrarRegla_Click" />
                    </form>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">    
        ...
        function eliminarRegla(id) {
            var hidId = document.getElementById('<%=hidIdRegla.ClientID %>');
            hidId.value = id;

            var boton = document.getElementById('<%=btnBorrarRegla.ClientID %>');
            boton.click();
        }
        ...
        function activarRegla(id) {
            ...
            var boton = document.getElementById('<%=btnActivarRegla.ClientID %>');
            boton.click();
        }
    </script>
</body>
