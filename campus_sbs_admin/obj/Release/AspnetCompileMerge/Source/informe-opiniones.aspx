<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="informe-opiniones.aspx.cs" Inherits="campus_sbs_admin.informe_opiniones" %>
...
<head runat="server">
    <title>SBS | Informe de estadísticas de opiniones</title>
    ...
    <!-- CSS 
     ...
     <style type="text/css">.course-box::before {border-right: 0 none;} .course-box .course-note { height:auto;}</style>
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    <div class="col-sm-12">
                        <fieldset>
                            <legend id="txt_informe_estadisticas" class="text-color-primary" runat="server"></legend>
                        </fieldset>
                    </div>
                    <div id="block_informe_status" class="row col-sm-12" runat="server"></div>                    
                    <div class="col-sm-12 padding-t-20">
                        <fieldset>
                            <legend class="text-color-primary" runat="server"><i class="fas fa-list"></i> ESTADÍSTICAS POR PROGRAMA</legend>
                        </fieldset>
                    </div>
                    <div id="table_listado_programas" class="col-sm-12 margin-b-15" runat="server"></div>
                    <div class="col-sm-12 padding-t-20">
                        <fieldset>
                            <legend class="text-color-primary" runat="server"><i class="fas fa-list"></i> ESTADÍSTICAS POR PROGRAMA DE OPINIONES VISIBLES</legend>
                        </fieldset>
                    </div>
                    <div id="table_listado_visibles" class="col-sm-12 margin-b-15" runat="server"></div>
                </div>
            </div>
        </section>
    </main>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#tabla_programs_active').DataTable({
                responsive: true,
                language: {
                    "sProcessing": "Procesando...",
                    "sLengthMenu": "Mostrar _MENU_ registros",
