<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lista-tipo-recursos-directo.aspx.cs" Inherits="campus_sbs_admin.lista_tipo_recursos_directo" %>
...
<head runat="server">
    <title>SBS | Listas de recursos en directo de una clase</title>
            ...
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    ...
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <div class="col-sm-12 padding-tb-30">
                            <a id="btn_back" href="lista-recursos-directo.aspx" class="btn btn-primary btn-block-xs margin-xs-b-15" runat="server">Volver</a>	
                            <asp:Button ID="btn_next" CssClass="btn btn-primary bg-color-success text-color-white btn-block-xs margin-b-15 pull-right" runat="server"
                                Text="Asignar y publicar" OnClick="btn_next_Click" />
                        </div>
