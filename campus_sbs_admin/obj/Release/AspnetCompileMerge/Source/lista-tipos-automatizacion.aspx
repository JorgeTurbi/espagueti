<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lista-tipos-automatizacion.aspx.cs" Inherits="campus_sbs_admin.lista_tipos_automatizacion" %>
...
<head runat="server">
    <title>SBS | Listas de tipos de automatización</title>
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    ...
                    <div id="table_listado_tipos" class="col-sm-12" runat="server"></div>

                    <!-- Hidden y botones ocultos -->
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <asp:HiddenField ID="hidIdTipoAutomatizacion" runat="server" />
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">    
        ...
        function eliminarTipo(id) {
            var hidId = document.getElementById('<%=hidIdTipoAutomatizacion.ClientID %>');
            hidId.value = id;
