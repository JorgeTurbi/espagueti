<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="matricula-pdp.aspx.cs" Inherits="campus_sbs_admin.matricula_pdp" %>
...
<head runat="server">
    <title>SBS | Matriculación pdp</title>
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    <div class="col-sm-12">
                        <fieldset>
                            <legend id="txt_matricula_pdp" class="text-color-primary" runat="server"></legend>
                        </fieldset>
                    </div>
                    <div id="table_listado_matriculas" class="col-sm-12" runat="server"></div>

                    <!-- Hidden y botones ocultos -->
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <asp:HiddenField ID="hidIdMatricula" runat="server" />
                        <asp:ImageButton ID="btnBorrarMatricula" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" OnClick="btnBorrarMatricula_Click" CssClass="hidden" />
                        <asp:ImageButton ID="btnSend" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" OnClick="btnSend_Click" CssClass="hidden" />
                    </form>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">    
        ...
        function eliminarMatricula(id) {
            var hidId = document.getElementById('<%=hidIdMatricula.ClientID %>');
            hidId.value = id;

            var boton = document.getElementById('<%=btnBorrarMatricula.ClientID %>');
            boton.click();
        }

        function send_mails() {
            var boton_send = document.getElementById('<%=btnSend.ClientID %>');
            boton_send.click();
        }
    </script>
</body>
