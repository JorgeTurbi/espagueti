<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="candidatos-mantenimiento.aspx.cs" Inherits="campus_sbs_admin.candidatos_mantenimiento" %>
...
<head runat="server">
    <title>SBS | Candidato mantenimiento</title>
...
<body>    
		    ...
		    <div class="row no-margin padding-nav">	
                <div class="col-sm-12">                         
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <div>
                            <fieldset>
							    <legend class="text-color-primary"><i class='fas fa-user-plus'></i> Manteniento de Candidato</legend>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript" src="/App_Themes/support/js/internal/candidate_functions.js"></script>
</body>
</html>
