<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="candidatos.aspx.cs" Inherits="campus_sbs_admin.candidatos" %>
...
<head runat="server">
    <title>SBS | Listado de solicitudes de prácticas</title>
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    <div class="col-sm-12">
                        <fieldset>
                            <legend id="txt_candidato" class="text-color-primary" runat="server"></legend>
                        </fieldset>
                    </div>
                    <div id="table_listado_candidatos" class="col-sm-12" runat="server"></div>

                    <!-- Hidden y botones ocultos -->
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <asp:HiddenField ID="hidIdCandidato" runat="server" OnValueChanged="hidIdCandidato_ValueChanged" />
                        <asp:ImageButton ID="btnBorrarCandidato" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" OnClick="btnBorrarCandidato_Click" CssClass="hidden" />
                    </form>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">    
        ...
        function eliminarCandidato(id) {
            var hidId = document.getElementById('<%=hidIdCandidato.ClientID %>');
            hidId.value = id;

            var boton = document.getElementById('<%=btnBorrarCandidato.ClientID %>');
            boton.click();
        }
    </script>
</body>
