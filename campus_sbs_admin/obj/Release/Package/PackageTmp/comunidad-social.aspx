<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comunidad-social.aspx.cs" Inherits="campus_sbs_admin.comunidad_social" %>
...
<head runat="server">
    <title>SBS | Comunidad Social</title>
...
<body>    
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    <div class="col-sm-12">
                        <fieldset>
                            <legend id="txt_rrss" class="text-color-primary" runat="server"></legend>
                        </fieldset>
                    </div>
                    <div id="table_listado_rrss" class="col-sm-12" runat="server"></div>

                    <!-- Hidden y botones ocultos -->
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <asp:HiddenField ID="hidIdRRSS" runat="server" />
                        <asp:ImageButton ID="btnActivarRRSS" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" CssClass="hidden" OnClick="btnActivarRRSS_Click" />
                    </form>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">    
        ...
        function activarRRSS(id) {
            var hidId = document.getElementById('<%=hidIdRRSS.ClientID %>');
            hidId.value = id;

            var boton = document.getElementById('<%=btnActivarRRSS.ClientID %>');
            boton.click();
        }
    </script>
</body>
