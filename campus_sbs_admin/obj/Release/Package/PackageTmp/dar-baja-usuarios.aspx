<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dar-baja-usuarios.aspx.cs" Inherits="campus_sbs_admin.dar_baja_usuarios" %>
...
<head runat="server">
    <title>SBS | Dar de baja usuarios</title>
		    ...
		    <div class="row no-margin padding-nav">	
                <div id="block_upload" class="col-sm-12" runat="server">                         
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <div>
                            <fieldset>
							    <legend class="text-color-primary"><i class='far fa-list-alt'></i> Dar de baja usuarios <a href="https://media.spainbs.com/recursos_www/campus_upload/Plantilla_Excel_Baja_Usuarios.xlsx" class='pull-right bold padding-r-5' target="_blank"><small class='text-color-primary'><i class="far fa-file-excel fa-2x text-color-green"></i> Plantilla Excel</small></a></legend>
                                ...
                                <div class="col">
                                    ...
                                    <asp:Button ID="btnGuardar" CssClass="btn btn-primary bg-color-success text-color-white btn-block-xs margin-b-15 pull-right" runat="server"
                                        Text="Guardar" OnClick="btnGuardar_Click" data-toggle='modal' data-target='#wait_modal' />
                                </div> 
                            </fieldset>
                        </div>                    
                    </form>
