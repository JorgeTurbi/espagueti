<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lista-suscriptores.aspx.cs" Inherits="campus_sbs_admin.lista_suscriptores" %>
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    <div class="col-sm-12">
                        <fieldset>
                            <legend id="txt_lista_suscriptores" class="text-color-primary" runat="server"></legend>
                        </fieldset>
                    </div>
                    <div id="table_listado_suscriptores" class="col-sm-12" runat="server"></div>
                    ...
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        ...
                        <asp:ImageButton ID="btnRefrescarListado" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" CssClass="hidden" OnClick="btnRefrescarListado_Click" />
                    </form>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">    
        ...
        function refrescarListado(id) {
            ...
            var boton = document.getElementById('<%=btnRefrescarListado.ClientID %>');
            boton.click();
        }
    </script>
</body>
