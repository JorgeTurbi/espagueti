<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="opinion-mantenimiento.aspx.cs" Inherits="campus_sbs_admin.opinion_mantenimiento" %>
...
<head runat="server">
    <title>SBS | Opinión mantenimiento</title>
...
<body>    
		    ...
		    <div class="row no-margin padding-nav">	
                <div class="col-sm-12">                         
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <div>
                            <fieldset>
							    <legend class="text-color-primary"><i class='fas fa-toolbox'></i> Manteniento de opinión</legend>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div id="cargo_form" class="form-group" runat="server">
								        <label class="sr-only" for="txt_cargo">Cargo</label>
									    <input type="text" placeholder="Cargo" id="txt_cargo" class="form-control" runat="server" maxlength="200" />
									    <span aria-hidden="true" class="glyphicon glyphicon-ko xs form-control-feedback"></span>
									    <span aria-hidden="true" class="glyphicon glyphicon-ok xs form-control-feedback"></span>																		
								    </div>
                                </div>
                                <div class="col-sm-6">
                                    ...
                                    <div id="curso_form" class="form-group" runat="server">                                       
                                        <select id="ddlCurso" runat="server" class="selectpicker" data-live-search="true" data-hide-disabled="true" onchange="cargarDocencias()"></select>
                                    </div>
                                </div>
                                <%--<div class="col-sm-6">
                                    <label>Docencia *</label>													
								    <div id="docencia_form" class="form-group" runat="server">
								        <label class="sr-only" for="ddlDocencia">Docencia</label>
                                        <select id="ddlDocencia" class="selectpicker" data-live-search="true" data-hide-disabled="true" runat="server"></select>
                                        <input type="hidden" id="id_Docencia" runat="server" />
								    </div>
                                </div>--%>
                                <div class="col-sm-6">
                                    <label>Texto Pregunta</label>													
								    <div id="question_form" class="form-group" runat="server">
								        <label class="sr-only" for="ddlTextoPregunta">Texto Pregunta</label>
									    <select id="ddlTextoPregunta" runat="server" class="selectpicker" data-live-search="true" data-hide-disabled="true"></select>
								    </div>
                                </div>
                                <div class="col-sm-3">
                                    <label>Foto</label>
                                    <div id="fichero_pra_form" class="form-group" runat="server">
								        <label class="sr-only" for="txtFoto">Foto</label>
                                        <input type="text" placeholder="Foto" id="txtFoto" class="form-control" runat="server" readonly="readonly" />
									    <span aria-hidden="true" class="glyphicon glyphicon-ko xs form-control-feedback"></span>
									    <span aria-hidden="true" class="glyphicon glyphicon-ok xs form-control-feedback"></span>
                                    </div>
                                </div>
                                <div class="col-sm-1">
                                    ...
                                    <div class="form-group margin-tb-5 text-center">
                                        <a id="txt_img_foto" href="#" target="_blank" runat="server" class="hidden"><i class='far fa-file-image fa-2x'></i></a>
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                    <label>Video</label>
                                    <div id="video_form" class="form-group" runat="server">
								        <label class="sr-only" for="txt_video">Video</label>
									    <input type="text" placeholder="Video" id="txt_video" class="form-control" runat="server" />
									    <span aria-hidden="true" class="glyphicon glyphicon-ko xs form-control-feedback"></span>
									    <span aria-hidden="true" class="glyphicon glyphicon-ok xs form-control-feedback"></span>																		
								    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <label>Permite contacto *</label>
                                    <div id="contacto_form" class="form-group padding-t-10" runat="server">													
							            <div class="checkbox">
                                            <asp:CheckBox ID="chkContacto" runat="server" Text="Permite contacto" /> 
							            </div>
						            </div>
                                </div>
                                <div class="col-sm-3">
                                    <label>Valoración</label>													
								    <div id="valoracion_form" class="form-group" runat="server">
								        <label class="sr-only" for="ddlValoracion">Valoración</label>
									    <asp:DropDownList ID="ddlValoracion" runat="server" CssClass="selectpicker">
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <div id="recomendacion_form" class="form-group padding-t-10" runat="server">													
							            <div class="checkbox">
                                            <asp:CheckBox ID="chkRecomendacion" runat="server" Text="Recomendación" /> 
							            </div>
						            </div>
                                </div>
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-12 ">
                                    <label>Huella</label>											
								    <div id='huella_form' class="form-group">
							            <label class="sr-only" for="txt_huella">Huella</label>
                                        <textarea id="txt_huella" placeholder="Huella" class="form-control" cols='2' rows='5' disabled="disabled" runat="server"></textarea>                            
						            </div>   
                                </div>
                                <div class="col-sm-12">
                                    <a href="lista-opiniones.aspx" class="btn btn-primary btn-block-xs margin-xs-b-15">Volver</a>	
   ...
   <!-- Scripts
    ...
    <script type="text/javascript" src="/App_Themes/support/js/internal/opinion_functions.js"></script>
</body>
</html>