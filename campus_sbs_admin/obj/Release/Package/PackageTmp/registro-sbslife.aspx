<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registro-sbslife.aspx.cs" Inherits="campus_sbs_admin.registro_sbslife" %>
...
<body>    
		    ...
		    <div class="row no-margin padding-nav">	
                <div id="block_upload" class="col-sm-12" runat="server">                         
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <div>
                            <fieldset>
							    <legend class="text-color-primary"><i class='far fa-list-alt'></i> Cargar usuarios <a href="https://media.spainbs.com/recursos_www/campus_upload/Plantilla_Excel_Suscripcion_SBSLife.xlsx" class='pull-right bold padding-r-5' target="_blank"><small class='text-color-primary'><i class="far fa-file-excel fa-2x text-color-green"></i> Plantilla Excel</small></a></legend>
                                ...
                                <div class="col">
                                    ...
                                    <%--<a href="javascript:void(0)" onclick="search_values(205)" class="btn btn-primary bg-color-success text-color-white btn-block-xs margin-b-15 pull-right">Prueba</a>--%>
                                </div> 
                            </fieldset>
                        </div>                    
                    </form>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">    
        ...
        function search_values(id) {
            var urlWS = "https://localhost:44349/api/migrate/register/" + id;
            var data = {}; //"{'id' : '" + id + "'}";
            $.ajax({
                type: "GET",
                crossDomain: true,
