<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="solicitud-practica.aspx.cs" Inherits="campus_sbs_admin.solicitud_practica" %>
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    <div class="col-sm-12">
                        <fieldset>
                            <legend id="txt_solicitud" class="text-color-primary" runat="server"></legend>
                        </fieldset>
                    </div>
                    <div id="table_listado_solicitudes" class="col-sm-12" runat="server"></div>

                    <!-- Hidden y botones ocultos -->
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <asp:HiddenField ID="hidIdSolicitud" runat="server" />
                        <asp:ImageButton ID="btnBorrarSolicitud" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" OnClick="btnBorrarSolicitud_Click" class="hidden" />
                    </form>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">    
        ...
        function eliminarSolicitud(id) {
            var hidId = document.getElementById('<%=hidIdSolicitud.ClientID %>');
            hidId.value = id;

            var boton = document.getElementById('<%=btnBorrarSolicitud.ClientID %>');
            boton.click();
        }
    </script>
</body>
