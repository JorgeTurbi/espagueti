<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="suscripcion-sbslife-mantenimiento.aspx.cs" Inherits="campus_sbs_admin.suscripcion_sbslife_mantenimiento" %>
...
<head runat="server">
    <title>SBS | Suscripción mantenimiento</title>
		    ...
		    <div class="row no-margin padding-nav">	
                <div class="col-sm-12">                         
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <div>
                            <fieldset>
							    <legend class="text-color-primary"><i class='fas fa-file-signature'></i> Manteniento de una suscripción</legend>
                                <div id="block_error" class="form-group has-error" runat="server">
                                    <span id="txt_error" class="help-block text-center bg-color-red text-color-white bold border-radius" runat="server"></span>
                                </div>
                                <div class="col-sm-6">
                                    <label>Alumno *</label>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div id="producto_form" class="form-group" runat="server">                                       
                                        <asp:DropDownList ID="ddlProducto" runat="server" CssClass="selectpicker" data-live-search="true" data-hide-disabled="true"></asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
								    ...
								    <div id="fechaFin_form" class="input-group date js-datepicker" runat="server">
                                ...
                                <div class="col-sm-4">
                                    <label>Importe *</label>
                                    <div id="importe_form" class="form-group" runat="server">
								        <label class="sr-only" for="txt_importe">Importe</label>
									    <input type="text" placeholder="Importe" id="txt_importe" class="form-control" runat="server" maxlength="10" />
									    <span aria-hidden="true" class="glyphicon glyphicon-ko xs form-control-feedback"></span>
									    <span aria-hidden="true" class="glyphicon glyphicon-ok xs form-control-feedback"></span>																		
								    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <a href="lista-suscripciones-sbslife.aspx" class="btn btn-primary btn-block-xs margin-xs-b-15">Volver</a>	
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#txt_alumno").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'suscripcion-sbslife-mantenimiento.aspx/search_student',
        ...
        function validarFormulario() {
            ...
            if (idAlumno === "undefined" || idAlumno === undefined || idAlumno === "null" || idAlumno === null || idAlumno === '') {
                ...
                $('#fechaFin_form').addClass(' has-error');
                $('#txt_error').html('La fecha de fin es obligatoria');
                subirArribaPagina();
                return false;
            }
            else if (importe === "undefined" || importe === undefined || importe === "null" || importe === null || importe === '' || !validarTelefono(importe.replace(',', '.'))) {
                $('#importe_form').addClass(' has-error');
                $('#txt_error').html('El campo importe es un campo numérico y obligatorio');
                subirArribaPagina();
                return false;
            }
            else
