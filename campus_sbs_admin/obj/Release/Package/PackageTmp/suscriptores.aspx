<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="suscriptores.aspx.cs" Inherits="campus_sbs_admin.suscriptores" %>
...
<head runat="server">
    <title>SBS | Listas de suscriptores</title>
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    <div class="col-sm-12">
                        <fieldset>
                            <legend id="txt_suscriptores" class="text-color-primary" runat="server"></legend>
                        </fieldset>
                    </div>
                    <div id="table_suscriptores" class="col-sm-12" runat="server"></div>
                    <div class="col-sm-12">
                        <fieldset>
                            <legend class="text-color-primary"><i class='far fa-list-alt'></i> Histórico</legend>
                        </fieldset>
                        <div id="table_historico" class="col-sm-12" runat="server"></div>
                    </div>

                    <!-- Hidden y botones ocultos -->
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <asp:HiddenField ID="hidIdSuscriptor" runat="server" />
                        <asp:ImageButton ID="btnBorrarSuscriptor" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" CssClass="hidden" OnClick="btnBorrarSuscriptor_Click" />
                    </form>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">    
        ...
        function eliminarSuscriptor(id) {
            var hidId = document.getElementById('<%=hidIdSuscriptor.ClientID %>');
            hidId.value = id;

            var boton = document.getElementById('<%=btnBorrarSuscriptor.ClientID %>');
            boton.click();
        }
    </script>
</body>
