<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ventas-curso.aspx.cs" Inherits="campus_sbs_admin.ventas_curso" %>
...
<!--<![endif]-->
<head runat="server">
    <title>SBS | Ventas por curso</title>
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    ...
                    <form action="/ventas-curso.aspx" method="post" runat="server">
                        <div class="col-sm-6 pull-right">
                            <div class="col-sm-4">
                                <div id="active_form" class="form-group padding-t-10" runat="server">
                                    <div class="checkbox">
                                        <asp:CheckBox ID="chk_active" runat="server" Text="Activo" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div id="close_form" class="form-group padding-t-10" runat="server">
                                    <div class="checkbox">
                                        <asp:CheckBox ID="chk_close" runat="server" Text="Cerrado" />
                                    </div>
                                </div>
                            </div>
                            <button type="submit" class="btn btn-success pull-right"><i class="fas fa-search"></i>Buscar</button>
                        </div>
                    </form>
