<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ventas-profesores.aspx.cs" Inherits="campus_sbs_admin.ventas_profesores" %>
...
<!--<![endif]-->
<head runat="server">
    <title>SBS | Ventas por autor</title>
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    ...
                    <form id="Form2" accept-charset="utf-8" runat="server">
