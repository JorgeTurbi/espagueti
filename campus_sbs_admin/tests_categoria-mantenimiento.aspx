<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tests_categoria-mantenimiento.aspx.cs" Inherits="campus_sbs_admin.tests_categoria_mantenimiento" %>
...
<head runat="server">
    <title>SBS | Test Categoría mantenimiento</title>
		    ...
		    <div class="row no-margin padding-nav">	
                <div class="col-sm-12">                         
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <div>
                            <fieldset>
							    <legend class="text-color-primary"><i class='fa fa-tags'></i> Mantenimiento de Test Categoría</legend>
                            ...
                            <div class="col-sm-12">
                                    <a href="tests_categoria.aspx" class="btn btn-primary btn-block-xs margin-xs-b-15">Volver</a>	
