<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ventas-tpv-sbslife.aspx.cs" Inherits="campus_sbs_admin.ventas_tpv_sbslife" %>
...
<head runat="server">
    <title>SBS | Ventas TPV SBS Life</title>
        ...
        <section class="padding-tb-40 padding-xs-tb-30">
            <div class="block-primary">
                <div class="row no-margin padding-nav">
                    ...
                    <div id="table_listado_ventas_tpv" class="col-sm-12" runat="server"></div>

                    <!-- Hidden y botones ocultos -->
                    <form id="Form1" accept-charset="utf-8" runat="server">
                        <asp:HiddenField ID="hidIdPedido" runat="server" />
                        <asp:ImageButton ID="btnConfirmarPedido" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" OnClick="btnConfirmarPedido_Click" CssClass="hidden" />
                        <asp:ImageButton ID="btnProcesarPedido" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" OnClick="btnProcesarPedido_Click" CssClass="hidden" />
                        <asp:ImageButton ID="btnProcesarSuscripcion" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" OnClick="btnProcesarSuscripcion_Click" CssClass="hidden" />
                        <asp:ImageButton ID="btnTodasVentas" runat="server" ImageUrl="~/App_Themes/support/img/pixel.png" OnClick="btnTodasVentas_Click" CssClass="hidden" />
                    </form>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">    
        ...
        function procesar_pedido(id) {
            $('#hidIdPedido').val(id);
            $('#btnProcesarPedido').click();
        }

        function procesar_suscripcion(id) {
            $('#hidIdPedido').val(id);
            $('#btnProcesarSuscripcion').click();
        }

        function all_sales() {
            $('#btnTodasVentas').click();
        }
    </script>
</body>
</html>