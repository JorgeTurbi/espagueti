<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ventas-tpv.aspx.cs" Inherits="campus_sbs_admin.ventas_tpv" %>
   ...
   <!-- Scripts
    ...
    <script type="text/javascript">    
        ...
        function confirmar_pedido(id) {
            var hidId = document.getElementById('<%=hidIdPedido.ClientID %>');
            hidId.value = id;

            var boton = document.getElementById('<%=btnConfirmarPedido.ClientID %>');
            boton.click();
        }
        ...
        function procesar_pedido(id) {
            ...
            var boton = document.getElementById('<%=btnProcesarPedido.ClientID %>');
            boton.click();
        }

        function all_sales() {
            var boton_all = document.getElementById('<%=btnTodasVentas.ClientID %>');
            boton_all.click();
        }
    </script>
</body>
